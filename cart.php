        ...
        $(document).ready(function() {
            ...
            if (productsArr.length) {
                ...
                for (let i = 0; i < productsArr.length; i++) {
                    const cartItem = `<div class="card p-card-landscape p-cart-box" style="height:max-content;">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="img-box-main">
                                                <a href="#" onclick="refresh(${productsArr[i]['productId']})" class="btn btn-primary btn-delete">
                                                    <i class="far fa-trash-alt"></i>
                                                </a>
                                                <div class="img-box" style="background-image:url('${productsArr[i]['productImage']}')"></div>
                                            </div>

                                            <div class="media-body">
                                                <div class="media-body-header">
                                                    <div class="left-box">
                                                        <a class="card-title" href="#">${productsArr[i]['productName']}</a>
                                                    </div>
                                                    <div class="right-box">
                                                        <div class="price-box">
                                                            <span>Unit Price (PKR): </span> <b>${productsArr[i]['productPrice']}</b>
                                                        </div>
                                                        <div class="price-details-box">

                                                        </div>

                                                        <div class="item quantity-box-main">
                                                            <div class="input-group quantity-box">
                                                                ...
                                                                <input type="number" min="1" name="quantity[${productsArr[i]['productId']}]" value="${productsArr[i]['productQuantity']}" class="form-control quantity">
                                                                <span class="input-group-btn">
                    ...
                    totalItems += Number(productsArr[i]['productQuantity'])
                    subtotal += (Number(productsArr[i]['productQuantity']) * Number(productsArr[i]['productPrice']))
                    cartItemsArea.insertAdjacentHTML('afterbegin', cartItem)
                ...
                cartItemsArea.insertAdjacentHTML('beforebegin', '<p>NO ITEMS IN CART</p>')
            }


            //if changing the values|quantity

            function changeValues(id, event) {
            ...
            <div id="cart_steps" class="steps-wizard">
                <div class="steps clearfix">
                    ...
                    <div class="step-content body current">
                        <div class="step-content-inner" id="step-cart" style="display:none;">
                            <div class="left-box" id="cart-items-area">

                                <!--<div class="d-none d-xl-block"  style="font-size: 1.5rem;font-weight: 700;">For Assistance, Offers & Discounts, Call : 0307-4227832</div>-->
                            ...
                            <div class="right-box">
                                <div class="order-summary-box">
                                    <div class="osb-inner-box">
                                        ...
                                        <ul class="items-list">
                                            <li>
                                                <div class="item">Subtotal (<span id="total_items">0</span> items )</div>
                                                <div class="item price-box"><span>PKR</span><span id="subtotal">0</span></div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                ---------------------->
                                        <!-- <div class="row mt-5">
                                    <div class="col">
                                        <h6 class="donate_us_text">Donate to help animals
                                            <button type="button"  class="btn btn-primary btn-sm donation_remove_button">Remove</button>
                                        </h6>
                                    </div>
                                </div> -->
                                ...
                                ------------------------>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control shadow-none donate_us_input" step="1"
                                            placeholder="Amount" aria-label="Amount" aria-describedby="basic-addon2"  
                                            min="0">
                                        <div class="input-group-append">
                                            <button class="btn donate_us_add_btn" type="submit">Confirm</button>
                                        </div>
                                    </div>
                                </form> -->

                                        <!------------------------------------
                                    Donation added text and amount 
                                ------------------------------------->
                                        <!-- <ul class="items-list mt-4">
                                <li class="donation_wrap donation_success text-success" style="display: none;">
                                        <div class="item donation_heading">Donation</div>
                                        <div class="item donation">
                                            <span>PKR</span> 
                                            <span id="donation_total">0</span>
                                        </div>                                      

                                    </li>
                                    <li class="donation_error text-danger" style="display: none;display: block;">
                                        <div class="item donation">
                                            <p class="donation_error_text"></p>
                                        </div>                                      
                                        ...
                                        <ul class="items-list total">
                                            ...
                                            <span id="discount_price_holder" style="display: none">0</span>
                                            <span id="coupon_code_holder" style="display: none"></span>
                                            <span id="donation_amount_holder" style="display: none">0</span>
                                        </ul>
                                        <div class="form-group">
                                            <a href="checkout.php" class="btn btn-callGreen btn-block" id="proceed-to-checkout" data-goto-next-step="true">Proceed to checkout</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
