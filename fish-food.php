...
<body>
    ...
    <div class="wrap-all">
        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Fish Food</li>
                </ol>
            </nav>
        </div>
        <div class="row small-padding-grid">
            ...
            $sql = "SELECT * FROM products WHERE product_for = 'fish' ORDER BY id DESC";
            ...
            ?>
              ...
              <p class="price"> -->
                                ...
                                <div class="buttons-box">
                                    ...
                                    <form action="" class="form-inline add-to-cart-form" method="post">
