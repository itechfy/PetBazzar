...
<head>
    ...
    <title>
        Contact Us - Best Online Food Store in Islamabad/Rawalpindi | Buy Pet Food
    </title>
    ...
    <div class="wrap-all">
        ...
        <div class="contact-us-map-box">
            <div class="container">
                ...
                <div class="shadow-box contact-form-box">
                    <div class="row pb-4">
                        <div class="col-sm-6 mt-4">
                            <form action="contactus-api.php" method="POST">
                                <div class="form-group has-float-label">
                                    <input type="text" class="form-control" pattern=".*[^ ].*" placeholder="John Doe" name="name" required="required">
                                    <label>Full Name</label>
                                </div>
                                <div class="form-group has-float-label">
                                    <input type="email" pattern="^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$" class="form-control" placeholder="john_doe@gmail.com" name="email" required="required">
                                    <label>Your Email</label>
                                </div>
                                <div class="form-group has-float-label">
                                    <input type="text" class="form-control" pattern=".*[^ ].*" placeholder="Please write your mail subject" name="subject" required="required">
                                    <label>Subject</label>
                                </div>
                                <div class="form-group has-float-label">
                                    <textarea type="text" class="form-control" pattern=".*[^ ].*" placeholder="Describe breifly" rows="3" name="message" required="required"></textarea>
                                    <label>Message</label>
                                </div>
                                <div>
                                    <br>
                                    <button type="submit" name="submit" class="btn btn-primary text-uppercase btn-lg">Submit</button>
                                </div>
                            </form>
                        </div>
                        <div class="col-sm-6 mt-4">
                            <h2 class="text-primary box-title">Feel free to drop by or call to say
                                <span>Hello!</span>
                            </h2>
                            Pets Bazzar.com<br>
                            I-14 Islamabad – Islamabad/Rawalpindi<br>
                            Phone: 0305-890-2090<br>
                            Monday to Friday<br>
                            0900 to 1700 Hours<br><br>
                            All about pets!
                        </div>
                    </div>
                </div>
                <div id="map" class="map" style="overflow: hidden;">
                    <div class="mapouter">
                        <div class="gmap_canvas"><iframe width="100%" height="100%" id="gmap_canvas" src="https://maps.google.com/maps?q=Islamabad&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                            <style>
                                .mapouter {
                                    position: relative;
                                    text-align: right;
