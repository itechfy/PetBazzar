            ...
            ?>
                    <div class="col-sm-6 col-md-3">
                        <div class="card e-card-small">
                            ...
                            <div class="card-body" id=<?php echo $product_id; ?>>
                                <h5 class="card-title"><a href="product-details.php?product_id=<?php echo $product_id; ?>"><?php echo $product_name; ?></a></h5>
                                <!-- <p class="card-text">
              ...
              <p class="price"> -->
                                ...
                                <div class="buttons-box">
                                    ...
                                    <button type="submit" class="btn btn-callGreen btn-call mr-auto btn-block d-flex justify-content-center" id="add_to_card" onclick="addToCart(this,<?php echo $product_id; ?>)">
