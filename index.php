...
<body>
    ...
    <div class="wrap-all">
        ...
        <section class="main-slider-section">
            <div class="container main-slider-box-container">
                <div class="main-slider-desc-box">

                    <div class="main-slider-form-box">
                        <h3 class="form-title">

                            <b>Search for Pets</b>
                        </h3>
                        <form action="pet-buy-sell.php">
                            <div class="row" style="justify-content:center;">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="form-group has-float-label">
                                        <select name="pet" class="form-control" id="type_id" required>
                                            <option value=""></option>
                                            <option value="Bird" type_id="6">Bird</option>
                                            <option value="Cat" type_id="1">Cat</option>
                                            <option value="Dog" type_id="2">Dog</option>
                                            <option value="Fish" type_id="3">Fish</option>
                                            <option value="__________" disabled type_id="-1">__________</option>
                                            <option value="Camel" type_id="3897">Camel</option>
                                            <option value="Cow" type_id="5">Cow</option>
                                            <option value="Crocodiles" type_id="14">Crocodiles</option>
                                            <option value="Deer" type_id="3903">Deer</option>
                                            <option value="Ferret" type_id="7">Ferret</option>
                                            <option value="Frogs &amp; Amphibians" type_id="18">Frogs &amp; Amphibians</option>
                                            <option value="Goat &amp; Lamb" type_id="3895">Goat &amp; Lamb</option>
                                            <option value="Guinea pigs" type_id="3409">Guinea pigs</option>
                                            <option value="Horse" type_id="9">Horse</option>
                                            <option value="Lion" type_id="3879">Lion</option>
                                            <option value="Lizards &amp; Iguana" type_id="15">Lizards &amp; Iguana</option>
                                            <option value="Monkey" type_id="10">Monkey</option>
                                            <option value="Mouse Hamsters Rats" type_id="19">Mouse Hamsters Rats</option>
                                            <option value="Other" type_id="3692">Other</option>
                                            <option value="Parrot" type_id="4">Parrot</option>
                                            <option value="Rabbit" type_id="13">Rabbit</option>
                                            <option value="Snakes" type_id="16">Snakes</option>
                                            <option value="Turtles &amp; Tortoise" type_id="17">Turtles &amp; Tortoise</option>
                                        </select>
                                        <label>Pet</label>
                                    </div>
                                </div>
                                <!-- <div class="col-12 col-md-6 col-lg-3">
                                <div class="form-group has-float-label">
                                    <select name="breed" class="form-control" id="breed-dd">
                                        <option value=""></option>
                                    </select>
                                    <label>Breed</label>
                                </div>
            ...
            <div class="main-slider">
                <div class="main-slider-item" style="background-image:url('img/buy&sell.webp')"></div>
                <div class="main-slider-item" style="background-image:url('img/eshop.webp')"></div>
                <div class="main-slider-item" style="background-image:url('img/pet-engage.webp')"></div>
                <div class="main-slider-item" style="background-image:url('img/pet-relocate.webp')"></div>
                <div class="main-slider-item" style="background-image:url('img/vet-shop.webp')"></div>
                <div class="main-slider-item" style="background-image:url('img/banners/app-banner-for-home-page.webp')"></div>
            </div>
        </section>

        <section class="red-boxes-section">
            <a href="pet-buy-sell.php" class="r-box">
                <div class="icon-box">
        ...
        <section class="search-map-section">
                    ...
                    <div class="col-box">
                        <div class="form-group text-center checkboxes">
                            <label class="custom-checkbox dark">
                                <input type="radio" name="type" value="Vet Clinic">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d27225.328104891913!2d74.25945263101292!3d31.464619114336386!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1536860389992" frameborder="0" style="border:0" allowfullscreen></iframe>
        </section>
                ...
                <div class="row about-us-row">
                    ...
                    <div class="col">
                        <figure class="img-box">
                            <img src="img/about-us-img.webp" alt="About Us">
                        </figure>
                    </div>
                </div>
            </div>
