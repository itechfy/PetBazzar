    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (productsArr) {
                ...
                const productToBuy = <?php
                                        echo $productId;
                                        ?>

                document.getElementById('sub_total').innerText = subTotal
                document.getElementById('cartCounter').innerText = cartCounter
                document.getElementById('price-total').innerText = parseInt(price)
                document.getElementById('total_price').innerText = parseInt(price)
                document.querySelector('input[name="shipping_cost"]').value = parseInt(price)
                document.querySelector('input[name="buyNow"]').value = JSON.stringify([
                    [productToBuy, 1]
                ])
                                        ...
                                        <div class="osb-inner-box">
                                            ...
                                            <ul class="items-list">
                                                <li>
                                                    ...
                                                    <div class="item price-box"> PKR <span id="price-total" style="font-size: 16px;">0</span></div>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="osb-inner-box">
                                            ...
                                            <ul class="items-list total">
                                                <li>
                                                    ...
                                                    <div class="item price-box"><span>PKR</span>&nbsp;<span id="total_price">00</span></div>
                                                </li>
                                                <span id="total_price_holder" style="display: none">00</span>
