    ...
    <body>
      <div class="sidebar">
        ...
        <ul class="nav-links">
          ...
          <li>
            <a href="admin/pages/totalPets.php">
              <i class='bx bx-book-alt'></i>
              <span class="links_name">Pets</span>
            </a>
          </li>
          <li>
            <a href="admin/pages/registeredusers.php">
          ...
          <li>
            <a href="admin/pages/messages.php">
      ...
      <section class="home-section">
        ...
        <div class="home-content">
            ...
            <div class="box">
              <div class="right-side">
                ...
                <div class="number"><?php
                                    ...
                                    function DealsCount($conn)
                                    {
                                      $sql = "SELECT COUNT(order_no) FROM orders";
                                      $result = mysqli_query($conn, $sql);
                                      $rows = mysqli_fetch_row($result);
                                      return $rows[0];
                                    }
                                    echo DealsCount($conn);
            ...
            <div class="recent-sales box">
              ...
              <div class="sales-details">
                <table>
                  ...
                  require_once "connect.php";
                  $result = mysqli_query($conn, "SELECT * FROM users WHERE typ = 'User'");
                  if (!empty($result)) {
          ...
          <div class="sales-boxes">
            <div class="recent-sales box">
              <div class="title"><i class='bx bx-user'></i>Registered Doctors</div>
              <div class="sales-details">
                <table>

                  <tr>
                    <th style="width: 150px; text-align: center;"></th>
                    <th style="width: 150px; text-align: center;">Doctors</th>
                    <th style="width: 150px; text-align: center;">Type</th>
                    <th style="width: 150px; text-align: center;">Delete</th>
                  ...
                  require_once "connect.php";
                  $result = mysqli_query($conn, "SELECT * FROM users WHERE typ = 'Doctor'");
                  if (!empty($result)) {
                    while ($row = mysqli_fetch_array($result)) {
                      echo "<tr>";
                      echo "<td style='width: 150px; text-align: center;'>";
                      ...
                      if ($row['typ'] == "Doctor") {
                        ...
                        if ($row['status'] == "Disabled") {
                          echo "<td style='width: 150px; text-align: center;'>";
                          echo "<a href='enable.php?uid=$uid' class='btn btn-sm btn-outline-primary text-uppercase'>Enable</a>";
                          echo "</td>";
                        }
                      }
                    }
